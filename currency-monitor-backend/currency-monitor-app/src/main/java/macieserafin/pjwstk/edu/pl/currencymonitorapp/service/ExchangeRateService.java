...
public class ExchangeRateService {
    ...
    public ExchangeRateDto getLatestRateForCurrency(String code) {

        log.info("Fetching latest exchange rate for currency code={}", code);
        ...
        return rateRepository
                ...
                .orElseThrow(() -> {
                    log.warn("No exchange rates found for currency code={}", code);
                    return new ExchangeRateNotFoundException(code);
                });
    }
}